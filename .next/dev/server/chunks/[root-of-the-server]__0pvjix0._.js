...
;
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://sknybbyxencuhbenshk.supabase.co");
...
async function POST(request) {
    try {
        ...
        const { data, error } = await supabase.from('cases').insert(body).select();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pvjix0._.js.map